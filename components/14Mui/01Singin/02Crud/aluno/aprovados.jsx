...
//iniciamos a funcao Listar alunos aprovados
const ListarAlunosAprovados = () => {
    ...
    //aqui criamos a funcao para calcular a media dos alunos    
    ...
    //aqui criamos a tabela para listar os alunos aprovados
    return (
        <> 
